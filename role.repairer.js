var roleRepairer = {
    run : function(creep){
        ...
        if(creep.memory.repairing){
            ...
            var adjustedList = _.remove(repairingList, function(structure) {return structure.structureType == STRUCTURE_WALL && structure.hits > 15000 || structure.structureType == STRUCTURE_ROAD && structure.hits > 5000})
